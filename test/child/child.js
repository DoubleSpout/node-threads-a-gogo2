...
var thread = tagg.create(th_func1,{fastthread:false,dirname:__dirname});

setTimeout(function(){
	 thread = tagg.create(th_func1,{fastthread:false,dirname:__dirname},thread_cb);
	 thread = tagg.create(th_func1,{buffer:buf,fastthread:false,dirname:__dirname},thread_cb);
...
setTimeout(function(){
	 thread2 = tagg.create(th_func2,{buffer:buf2,fastthread:false,dirname:__dirname},thread_cb2);
	 thread3 = tagg.create(th_func3,{buffer:buf3,fastthread:false,dirname:__dirname},thread_cb3);
	 thread4 = tagg.create(th_func4,{buffer:buf,fastthread:false,dirname:__dirname},thread_cb4);
	 thread5 = tagg.create(th_func5,{buffer:buf,fastthread:false,dirname:__dirname},thread_cb5);
	 thread6 = tagg.create(th_func6,{buffer:buf,fastthread:false,dirname:__dirname},thread_cb6);
	
},5000)

setTimeout(function(){
	 
	 thread7 = tagg.create(th_func7,{buffer:buf,fastthread:false,dirname:__dirname},thread_cb7);
},8000)
