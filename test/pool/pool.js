...
th_func7 = function(){
	console.log('multi require __dirname:'+__dirname)
	var obj = thread.id
	thread.end()
}
...
var threadp2 = tagg.create(th_func1,{buffer:buf,poolsize:3,dirname:__dirname});


setTimeout(function(){
	threadp1.pool(th_func1,thread_cb);
	threadp1.pool(th_func1,{buffer:buf,fastthread:true},thread_cb);
...
setTimeout(function(){
	threadp2.pool(th_func2,{buffer:buf2},thread_cb2);
	threadp2.pool(th_func3,{buffer:buf3},thread_cb3);
	threadp2.pool(th_func4,{buffer:buf},thread_cb4);
	threadp2.pool(th_func5,{buffer:buf},thread_cb5);
	threadp2.pool(th_func6,{buffer:buf},thread_cb6);
	
},5000)

setTimeout(function(){
	 
	 threadp2.pool = tagg.create(th_func7,{buffer:buf},thread_cb7);
},8000)
