...
var thread = tagg.create(th_func1);
var thread = tagg.create(th_func1,{fastthread:true});

setTimeout(function(){
	 thread = tagg.create(th_func1,thread_cb);
	 thread = tagg.create(th_func1,{buffer:buf,fastthread:true},thread_cb);
...
setTimeout(function(){
	 thread2 = tagg.create(th_func2,{buffer:buf2},thread_cb2);
	 thread3 = tagg.create(th_func3,{buffer:buf3},thread_cb3);
	 thread4 = tagg.create(th_func4,{buffer:buf},thread_cb4);
	 thread5 = tagg.create(th_func5,{buffer:buf},thread_cb5);
	 thread6 = tagg.create(th_func6,{buffer:buf},thread_cb6);
	
},5000)

setTimeout(function(){
	 
	 thread7 = tagg.create(th_func7,{buffer:buf},thread_cb7);
},8000)
